...
namespace DTC.UI
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlBackground.Controls.Add(this.LbVersion);
			...
			this.LbVersion.Location = new System.Drawing.Point(382, 83);
			this.LbVersion.Name = "LbVersion";
			this.LbVersion.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.LbVersion.Size = new System.Drawing.Size(117, 20);
			this.LbVersion.TabIndex = 1;
			this.LbVersion.Text = "V 3.3.0 - RC 14";
			// 
			// pnlContent
			// 
